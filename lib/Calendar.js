  ...
  _createClass(Calendar, [{
    ...
    value: function daysOfMonth() {
      ...
      for (var dateIndex = 1; dateIndex < daysInMonth; dateIndex += 1) {
        var dt = new Date((0, _format2.default)(this.state.date, 'MM/' + dateIndex + '/YYYY'));
        var isDisabled = (0, _is_before2.default)(dt, new Date((0, _format2.default)(this.props.minDate, 'MM/DD/YYYY'))) || (0, _is_after2.default)(dt, new Date((0, _format2.default)(this.props.maxDate, 'MM/DD/YYYY')));
