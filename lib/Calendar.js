...
var Calendar = function (_Component) {
  ...
  _createClass(Calendar, [{
    ...
    value: function handleDateSelected(evt) {
      var dateNotBeforeMin = !(0, _is_before2.default)(evt.target.dataset.date, new Date((0, _format2.default)(this.props.minDate, 'MM/DD/YYYY')));
      var dateNotAfterMax = !(0, _is_after2.default)(evt.target.dataset.date, new Date((0, _format2.default)(this.props.maxDate, 'MM/DD/YYYY')));
    ...
    value: function daysOfMonth() {
      ...
      for (var dateIndex = 1; dateIndex < daysInMonth; dateIndex += 1) {
        var isDisabled = (0, _is_before2.default)(new Date((0, _format2.default)(this.state.date, 'MM/' + dateIndex + '/YYYY')), new Date((0, _format2.default)(this.props.minDate, 'MM/DD/YYYY'))) || (0, _is_after2.default)(new Date((0, _format2.default)(this.state.date, 'MM/' + dateIndex + '/YYYY')), new Date((0, _format2.default)(this.props.maxDate, 'MM/DD/YYYY')));
